...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("SQLITE_PATH", str(DATA_DIR / "kajax.db")),
    }
}
...
PIECODE_WORKSPACE_ID = os.environ.get("PIECODE_WORKSPACE_ID", "kajax").strip()
PIECODE_EVENTS_SDK_ENABLED = env_bool("PIECODE_EVENTS_SDK_ENABLED", default=True)
PIECODE_EVENTS_SDK_URL = os.environ.get("PIECODE_EVENTS_SDK_URL", "https://piecode.pl/sdk/piecode-events.js").strip()
PIECODE_EVENTS_AUTO_CONSENT = env_bool("PIECODE_EVENTS_AUTO_CONSENT", default=True)
PIECODE_EVENTS_AUTO_PAGE_VIEW = env_bool("PIECODE_EVENTS_AUTO_PAGE_VIEW", default=True)
