...
CONTENT = {
    "pl": {
        ...
        "pages": {
            "home": {
                "title": "Kajax Stolarstwo | Drewniane komponenty dla firm i stolarka na wymiar",
                "description": "Stolarnia z Gościcina. Komponenty z drewna dla firm, próbki i krótkie serie, schody, drzwi, listwy oraz detale na wymiar. Lokalnie Pomorskie, B2B także wysyłkowo.",
                ...
                "h1": "Stolarnia dla firm, inwestycji i projektów spoza katalogu",
                "lead": "Wykonujemy drewniane komponenty do produktów i ekspozycji, próbki, krótkie serie, schody, drzwi, listwy oraz detale na wymiar. Wyślij zdjęcie, rysunek lub wzór. Odpowiemy, czy możemy to zrobić, od czego zacząć i co będzie potrzebne do wyceny.",
                "primary_cta": "Wyślij zdjęcie lub wzór",
                "secondary_cta": "Zobacz ofertę",
            },
            "production": {
                "title": "Drewniane komponenty dla firm, próbki i krótkie serie | Kajax",
                "description": "Komponenty z drewna dla producentów, agencji i wykonawców. Profile, listwy, elementy POS, próbki, krótkie serie i powtarzalne partie według wzoru.",
                ...
                "h1": "Drewniane komponenty dla firm, od próbki do małej serii",
                "lead": "Dla producentów, agencji reklamowych, wykonawców wnętrz i marek, które potrzebują elementów z drewna bez utrzymywania własnej stolarni. Możemy przygotować próbkę, partię testową albo kolejne zamówienia według ustalonego wzoru.",
                "primary_cta": "Pokaż element do wykonania",
                "sections": [
                    {
                        "title": "Elementy, które mają wracać w zamówieniach",
                        "body": "Najlepiej działamy przy częściach o stałym kształcie i zastosowaniu: profilach, listwach, ramach, detalach POS, elementach do produktów, ekspozycji albo dalszego montażu.",
                        "items": ["profile, listwy i ramy", "elementy POS, displaye i ekspozytory", "detale do produktów lub mebli", "próbki i partie wdrożeniowe"],
                    },
                    {
                        "title": "Próbka przed większym zamówieniem",
                        "body": "Jeśli element ma trafić do produktu, ekspozycji lub regularnej sprzedaży, warto najpierw sprawdzić materiał, wymiar, krawędzie i wykończenie. Po akceptacji próbki łatwiej przejść do kolejnych partii.",
                        "items": ["prototyp lub pierwsza próbka", "stały wzór wykonania", "powtarzalny efekt w kolejnych partiach", "pakowanie pod odbiór albo wysyłkę"],
                    },
                    {
                        "title": "Od czego zacząć rozmowę",
                        "body": "Wyślij zdjęcie, rysunek, istniejący wzór lub prosty opis. Najbardziej pomaga liczba sztuk, materiał, termin oraz informacja, czy element ma być gotowy do użycia, czy do dalszej obróbki.",
                        "items": ["zdjęcie, rysunek lub wzór", "orientacyjna liczba sztuk", "materiał i standard wykończenia", "termin oraz odbiór lub wysyłka"],
                    },
                ],
                "faq": [
                    ("Czy realizujecie zamówienia B2B poza Pomorzem?", "Tak. Przy elementach, które można bezpiecznie zapakować, rozmawiamy o wysyłce w Polsce i Europie."),
                    ("Czy można zamówić najpierw jedną próbkę?", "Tak. Przy powtarzalnych komponentach próbka pomaga potwierdzić wymiar, wykończenie i koszt kolejnych partii."),
                ],
            },
            "construction": {
                ...
                "h1": "Schody, drzwi i wykończenia z drewna na wymiar",
                "lead": "Dla domów, lokali i inwestycji w Pomorskiem wykonujemy stolarkę, która musi pasować do miejsca: schody, drzwi, listwy, progi, opaski, parapety i zabudowy. Pracujemy lokalnie: Gościcino, Wejherowo, Trójmiasto i okolice.",
                "primary_cta": "Opisz stolarkę do wykonania",
                "sections": [
                    {
                        "title": "Stolarka, która musi pasować do wnętrza",
                        "body": "To prace, w których liczy się pomiar, stabilne wykonanie i czyste wykończenie widocznych krawędzi.",
                    ...
                    {
                        "title": "Co pomaga przed pomiarem",
                        "body": "Do pierwszej odpowiedzi wystarczą zdjęcia miejsca, orientacyjne wymiary i informacja, kiedy planowany jest montaż.",
                        "items": ["zdjęcia miejsca montażu", "rzut, szkic lub podstawowe wymiary", "materiał lub oczekiwany kolor", "miejscowość i planowany termin"],
                    },
                ],
                "faq": [
            ...
            "architects": {
                ...
                "description": "Nietypowe detale drewniane, elementy do wnętrz, lokali i ekspozycji. Stolarka według projektu dla architektów, projektantów, wykonawców i firm.",
                ...
                "h1": "Nietypowe detale z drewna dla architektów i firm",
                "lead": "Dla projektów, w których katalogowy element psuje efekt albo nie pasuje technicznie. Wykonujemy drewniane detale do wnętrz, lokali, ekspozycji i produktów, pracując od rysunku, wizualizacji, zdjęcia lub istniejącego wzoru.",
                "primary_cta": "Pokaż detal do wykonania",
                "sections": [
                    {
                        "title": "Gdy liczy się widoczny detal",
                        "body": "Pomagamy tam, gdzie drewno ma być częścią efektu wnętrza, ekspozycji albo produktu: ma pasować, dobrze się starzeć i wyglądać tak, jak zaplanowano.",
                        "items": ["detale do wnętrz premium", "elementy ekspozycji i lokali", "zabudowy według projektu", "odtworzenia lub nietypowe profile"],
                    },
                    {
                        "title": "Od projektu do wykonania",
                        "body": "Na początku wystarczy rysunek, wizualizacja, zdjęcie inspiracji albo stary element do odtworzenia. Ustalimy materiał, proporcje, sposób montażu i ewentualną próbkę.",
                        "items": ["widoczne krawędzie i łączenia", "nietypowy profil lub kształt", "materiał dobrany do wnętrza", "próbka przy powtarzalnym detalu"],
                    },
                ],
                "faq": [
                    ("Czy wykonujecie pojedyncze nietypowe elementy?", "Tak, jeśli znamy efekt, wymiary, materiał i sposób użycia elementu."),
                    ("Czy pracujecie z architektami?", "Tak. Najlepszy start to rysunek, wizualizacja, inspiracja, materiał i opis oczekiwanego efektu."),
                ],
            },
            "realizations": {
                "title": "Realizacje i typy projektów stolarskich | Kajax",
                "description": "Zobacz typy zleceń dla Kajax: komponenty drewniane dla firm, stolarka na wymiar w Pomorskiem i nietypowe detale projektowe.",
                "h1": "Realizacje i przykłady zleceń",
                "lead": "Pokazujemy trzy kierunki pracy: komponenty dla firm, stolarkę montowaną w Pomorskiem oraz nietypowe detale z drewna. Jeśli widzisz podobny problem u siebie, wyślij zdjęcie, rysunek albo wzór.",
            },
            "quote": {
                "title": "Wyślij zapytanie | Kajax Stolarstwo",
                "description": "Wyślij zdjęcie, rysunek albo opis. Kajax odpowie, czy może wykonać komponent z drewna, krótką serię lub stolarkę na wymiar.",
                "h1": "Wyślij zapytanie do stolarni",
                "lead": "Nie potrzebujesz gotowego projektu. Pokaż, co ma powstać, zostaw telefon lub email i dodaj najważniejsze dane: wymiary, ilość, termin, miejsce realizacji. Jeśli czegoś zabraknie, wrócimy z konkretnymi pytaniami.",
            },
            "contact": {
                ...
                "lead": "Najprościej wysłać formularz ze zdjęciem, rysunkiem albo opisem. Przy pilnych sprawach można zadzwonić, ale materiał do obejrzenia pozwala szybciej odpowiedzieć konkretnie.",
            },
        },
        "process_steps": [
            ("Wysyłasz zdjęcie, rysunek lub wzór", "Może to być szkic, próbka, link do inspiracji albo opis elementu i jego zastosowania."),
            ("Ustalamy dane do wyceny", "Materiał, wymiar, ilość, termin, montaż, odbiór albo wysyłka."),
            ("Dobieramy najlepszy start", "Próbka, mała partia, pomiar, rozmowa techniczna albo od razu wycena."),
            ("Dostajesz konkretną odpowiedź", "Mówimy, co możemy zrobić, co trzeba jeszcze ustalić i jaki jest kolejny krok."),
        ],
        "audience_cards": [
            {"title": "Komponenty dla firm", "body": "Profile, listwy, elementy POS, detale do produktów i krótkie serie według wzoru.", "url": PATHS["production"], "cta": "Produkcja dla firm"},
            {"title": "Stolarka do domu lub lokalu", "body": "Schody, drzwi, listwy i zabudowy w Pomorskiem, gdy element musi pasować do miejsca.", "url": PATHS["construction"], "cta": "Stolarka budowlana"},
            {"title": "Detale pod projekt", "body": "Elementy do wnętrz, ekspozycji i projektów, w których gotowy produkt nie daje oczekiwanego efektu.", "url": PATHS["architects"], "cta": "Projekty specjalne"},
        ],
        "realization_cases": [
            {"title": "Komponenty drewniane dla firm", "category": "Produkcja B2B", "photo": "b2b_components_detail", "alt": "Ułożone w stosy drewniane profile przygotowane jako seria dla firmy", "meta": ["profile, listwy i detale", "próbka przed partią", "odbiór lub wysyłka"], "body": "Dla firm, które potrzebują profili, ekspozytorów, elementów POS albo części do dalszego montażu. Najlepszy start to wzór lub próbka."},
            {"title": "Schody, drzwi i wykończenia", "category": "Stolarka budowlana", "photo": "stairs_project", "alt": "Drewniane schody z balustradą w jasnym wnętrzu", "meta": ["pomiar na miejscu", "drewno lite lub klejone", "Gościcino, Wejherowo, Trójmiasto"], "body": "Dla domów i lokali w Pomorskiem, gdzie element musi pasować do miejsca, materiału i standardu wnętrza."},
            {"title": "Detale do wnętrz i ekspozycji", "category": "Projekty specjalne", "photo": "precision_detail", "alt": "Zbliżenie na starannie wykonane połączenie drewnianych elementów", "meta": ["rysunek lub inspiracja", "dobór technologii", "wykończenie widocznych powierzchni"], "body": "Dla projektów, w których gotowy produkt nie daje efektu: lokal, stoisko, wnętrze premium, nietypowy profil albo widoczny detal."},
        ],
    },
}
...
GUIDE_PAGES = {
    "pl": {
        "title": "Co wysłać do stolarni przed wyceną? | Kajax",
        "description": "Prosta checklista dla firm i inwestorów: zdjęcia, wymiary i informacje potrzebne przed wyceną komponentów drewnianych, schodów, drzwi lub detali.",
        "eyebrow": "Przed wyceną",
        "h1": "Co wysłać do stolarni, żeby szybko dostać odpowiedź?",
        "lead": "Nie potrzebujesz pełnej dokumentacji. Wystarczy pokazać, co ma powstać, podać orientacyjne wymiary, liczbę sztuk, termin i miejsce realizacji.",
        "primary_cta": "Wyślij zapytanie",
        "aside_title": "Minimum na start",
        "aside_body": "Jeśli nie masz rysunku technicznego, wyślij zdjęcie z telefonu, szkic albo przykład podobnego elementu. Resztę danych można uzupełnić w rozmowie.",
        "aside_items": ["zdjęcie, szkic albo rysunek", "orientacyjne wymiary", "liczba sztuk", "materiał lub oczekiwany wygląd", "termin i lokalizacja"],
        "sections": [
            {"title": "Dla komponentów i krótkich serii", "body": "Najbardziej pomaga punkt odniesienia: zdjęcie, rysunek, prototyp albo istniejąca próbka. Dzięki temu szybciej ustalimy, czy zacząć od jednej próbki, małej partii czy kolejnych zamówień według wzoru.", "items": ["pierwsza partia i skala docelowa", "czy element ma być gotowy, czy do dalszego montażu", "tolerancje, frezy, otwory i widoczne krawędzie", "pakowanie lub wysyłka", "czy element będzie zamawiany ponownie"]},
            {"title": "Dla schodów, drzwi i montażu", "body": "Przy stolarce montowanej liczy się miejsce, etap prac i możliwość pomiaru. Zdjęcia z telefonu często wystarczą, żeby ruszyć z pierwszą odpowiedzią.", "items": ["miejscowość inwestycji", "zdjęcia miejsca montażu", "rzuty, pomiary lub orientacyjne wymiary", "oczekiwany termin", "budowa, remont czy wymiana istniejącego elementu"]},
            {"title": "Dla detali projektowych", "body": "Przy nietypowych elementach opisz oczekiwany efekt, miejsce użycia i priorytet: wygląd, trwałość, powtarzalność albo budżet. To pomaga dobrać technologię bez zabijania charakteru projektu.", "items": ["rysunek, inspiracja lub wizualizacja", "materiał i kolorystyka", "miejsce montażu lub sposób użycia", "widoczne detale i oczekiwany standard", "elementy, które można uprościć technologicznie"]},
        ],
        "avoid_title": "Co zwykle blokuje wycenę",
        ...
        "avoid_items": ["brak wymiarów", "brak informacji o liczbie sztuk", "inspiracje bez wskazania, co ma być wykonane", "niejasny termin", "brak telefonu albo emaila do odpowiedzi"],
        "faq": [
...
SHORT_SERIES_GUIDE_PAGES = {
    "pl": {
        "title": "Od próbki do krótkiej serii drewnianych komponentów | Kajax",
        "description": "Poradnik B2B: jak zacząć od próbki drewnianego komponentu, kiedy zamówić krótką serię i jakie dane wysłać do wyceny.",
        "eyebrow": "Produkcja dla firm",
        "h1": "Od próbki do krótkiej serii drewnianych komponentów",
        "lead": "Jeśli element z drewna ma trafić do produktu, ekspozycji albo kolejnych zamówień, nie trzeba od razu zamawiać dużej partii. Najbezpieczniej sprawdzić wzór, materiał i wykończenie na próbce, a dopiero potem powtarzać element.",
        "primary_cta": "Wyślij komponent do wyceny",
        "aside_title": "Dobra seria zaczyna się od wzoru",
        "aside_body": "Najlepsze zapytania B2B mają jeden jasny punkt odniesienia: zdjęcie, rysunek, próbkę albo istniejący element, który można powtórzyć.",
        "aside_items": ["element będzie zamawiany ponownie", "liczy się powtarzalność wymiaru", "masz wzór, zdjęcie lub rysunek", "potrzebujesz próbki przed partią", "nie chcesz budować własnego zaplecza"],
        "sections": [
            {"title": "Komponent, który będzie wracał", "body": "Mała seria działa najlepiej, gdy po pierwszej partii można powtórzyć ten sam element bez projektowania od zera. Warto wtedy dopracować wzór, tolerancje, wykończenie, pakowanie i sposób odbioru.", "items": ["listwy, profile i ramy", "drewniane elementy do dalszego montażu", "elementy POS, ekspozycji i displayów", "detale do mebli lub wnętrz", "części wykonywane według stałego wzoru"]},
            {"title": "Zamiast własnego warsztatu", "body": "Dla wielu firm największym kosztem jest nie sama obróbka drewna, tylko miejsce, sprzęt, czas i ludzie potrzebni do małej niestandardowej partii. Zewnętrzna stolarnia pozwala sprawdzić komponent bez rozbudowywania własnej produkcji.", "items": ["brak własnej stolarni", "zbyt mała partia na produkcję przemysłową", "potrzeba próbki przed decyzją", "krótki termin wdrożenia", "ważny detal widoczny dla klienta"]},
            {"title": "Próbka przed partią", "body": "Próbka zmniejsza ryzyko, jeśli element ma być później powtarzany. Pozwala ocenić materiał, krawędzie, frezy, otwory, kolor i tolerancje przed większym zamówieniem.", "items": ["nowy element bez historii produkcji", "widoczny detal dla klienta końcowego", "niepewny materiał lub wykończenie", "większa partia po testach", "sprawdzenie pakowania i wysyłki"]},
        ],
...
STAIRS_PRICING_GUIDE_PAGES = {
    "pl": {
        ...
        "lead": "Na cenę schodów wpływa nie tylko liczba stopni. Ważny jest układ, miejsce montażu, materiał, wykończenie, etap inwestycji i możliwość dokładnego pomiaru. Im wcześniej znamy te dane, tym szybciej możemy podać uczciwą odpowiedź.",
        ...
        "sections": [
            ...
            {"title": "Etap inwestycji i montaż", "body": "Termin zależy od gotowości miejsca, możliwości pomiaru, dostępności materiału i kolejności prac na budowie. Najlepiej zgłosić schody zanim wykończenia zamkną dostęp do miejsc pomiarowych.", "items": ["czy są gotowe posadzki i ściany", "czy można wykonać pomiar", "czy schody mają pasować do innych elementów wnętrza", "termin wejścia innych ekip", "lokalizacja w Pomorskiem i dojazd"]},
        ],
...
ADVERTISING_EVENT_GUIDE_PAGES = {
    "pl": {
        "title": "Drewniane elementy POS, displaye i detale eventowe | Kajax",
        ...
        "h1": "Drewniane elementy POS, displaye i detale eventowe",
        "lead": "Drewno sprawdza się, gdy ekspozycja, stoisko albo detal marki ma wyglądać solidniej niż typowy nośnik z tworzywa. Wykonujemy prototypy, krótkie serie i powtarzalne elementy na podstawie zdjęcia, rysunku, wzoru albo specyfikacji.",
        "primary_cta": "Wyślij szkic lub wizualizację",
        ...
        "sections": [
            {"title": "Gdy ekspozycja ma wyglądać lepiej niż plastik", "body": "Drewno warto rozważyć przy elementach, które budują wrażenie marki, wracają w kolejnych kampaniach albo pracują jako detal premium. Najlepiej przygotować wymiar, materiał, sposób montażu i informację, które strony będą widoczne.", "items": ["ekspozytory i displaye", "podstawki, ramy i elementy ekspozycji", "detale do stoisk i scenografii", "drewniane nośniki oznaczeń", "elementy do krótkiej serii kampanijnej"]},
            {"title": "Prototyp przed kampanią", "body": "Przy kampaniach i eventach często najlepiej zacząć od prototypu albo pierwszej małej partii. To pozwala sprawdzić proporcje, stabilność, wykończenie, widoczne krawędzie i pakowanie.", "items": ["pierwszy wzór do akceptacji", "dopasowanie materiału i koloru", "test stabilności lub montażu", "krótka seria po akceptacji próbki", "możliwość powtarzania w kolejnych kampaniach"]},
...
RELATED_LINK_SECTIONS = {
    "pl": {
        "production": {
            ...
            "related_title": "Jak przygotować komponent do rozmowy",
            "related_links": [
                {"page": "short_series", "eyebrow": "Próbka i seria", "title": "Od próbki do krótkiej serii", "body": "Jak sprawdzić wzór, materiał i wykończenie przed kolejną partią."},
                {"page": "guide", "eyebrow": "Wycena", "title": "Co wysłać do stolarni", "body": "Zdjęcia, wymiary i dane, które przyspieszają konkretną odpowiedź."},
            ],
        },
        "guide": {
            "related_eyebrow": "Dalszy krok",
            "related_title": "Jeśli chodzi o komponenty dla firmy",
            "related_links": [
                {"page": "short_series", "eyebrow": "B2B", "title": "Od próbki do krótkiej serii", "body": "Dla firm, które chcą sprawdzić element przed kolejnymi partiami."},
                {"page": "production", "eyebrow": "Oferta", "title": "Komponenty drewniane dla firm", "body": "Profile, listwy, elementy POS i detale wykonywane według wzoru."},
            ],
        },
        "short_series": {
            "related_eyebrow": "Dalszy krok",
            "related_title": "Przygotuj element do wyceny",
            "related_links": [
                {"page": "guide", "eyebrow": "Wycena", "title": "Co wysłać do stolarni", "body": "Minimum danych, które pozwala szybko odpowiedzieć."},
                {"page": "production", "eyebrow": "Oferta", "title": "Komponenty drewniane dla firm", "body": "Próbki, krótkie serie i elementy wykonywane według wzoru."},
            ],
        },
    },
    "en": {
...
STAIRS_RELATED_LINK_SECTIONS = {
    "pl": {
        "construction": {
            ...
            "related_title": "Schody, drzwi i montaż bez zgadywania",
            "related_links": [
                ...
                {"page": "guide", "eyebrow": "Wycena", "title": "Co wysłać do stolarni", "body": "Zdjęcia, wymiary i informacje, które przyspieszają odpowiedź."},
            ],
        },
        "stairs_pricing": {
            "related_eyebrow": "Dalszy krok",
...
ADVERTISING_RELATED_LINK_SECTIONS = {
    "pl": {
        "production": {
            ...
            "related_links": [
                {"page": "short_series", "eyebrow": "Próbka i seria", "title": "Od próbki do krótkiej serii", "body": "Jak sprawdzić wzór, materiał i wykończenie przed kolejną partią."},
                {"page": "advertising_events", "eyebrow": "Reklama i eventy", "title": "Drewniane elementy POS i displaye", "body": "Jak opisać display, prototyp albo serię pod kampanię."},
                {"page": "guide", "eyebrow": "Wycena", "title": "Co wysłać do stolarni", "body": "Zdjęcia, wymiary i dane, które przyspieszają konkretną odpowiedź."},
            ],
        },
        "guide": {
            ...
            "related_links": [
                {"page": "production", "eyebrow": "Oferta", "title": "Komponenty drewniane dla firm", "body": "Profile, listwy, elementy POS i detale wykonywane według wzoru."},
                {"page": "short_series", "eyebrow": "Próbka i seria", "title": "Od próbki do krótkiej serii", "body": "Dla firm, które chcą sprawdzić element przed kolejnymi partiami."},
                {"page": "advertising_events", "eyebrow": "Reklama i eventy", "title": "Drewniane elementy POS i displaye", "body": "Osobna ścieżka dla displayów, POS i serii kampanijnych."},
            ],
        },
        "short_series": {
            "related_eyebrow": "Dalszy krok",
            ...
            "related_links": [
                {"page": "production", "eyebrow": "Oferta", "title": "Komponenty drewniane dla firm", "body": "Próbki, krótkie serie i elementy wykonywane według wzoru."},
                {"page": "advertising_events", "eyebrow": "Reklama i eventy", "title": "Drewniane elementy POS i displaye", "body": "Jak opisać display, prototyp lub serię na event."},
                {"page": "guide", "eyebrow": "Wycena", "title": "Co wysłać do stolarni", "body": "Minimum danych, które pozwala szybko odpowiedzieć."},
            ],
        },
        "advertising_events": {
            ...
            "related_links": [
                {"page": "production", "eyebrow": "Oferta", "title": "Komponenty drewniane dla firm", "body": "Próbki, krótkie serie i elementy wykonywane według wzoru."},
                {"page": "short_series", "eyebrow": "Próbka i seria", "title": "Od próbki do krótkiej serii", "body": "Jak przejść od pierwszego wzoru do powtarzalnej partii."},
                {"page": "guide", "eyebrow": "Wycena", "title": "Co wysłać do stolarni", "body": "Minimum danych, które pozwala szybko odpowiedzieć."},
            ],
        },
    },
