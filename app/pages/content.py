    ...
    "pl": {
        ...
        "pages": {
            "home": {
                ...
                "lead": "Łączymy warsztat produkcyjny z doświadczeniem w stolarce na wymiar. Wykonujemy elementy drewniane, stolarkę budowlaną i projekty specjalne: od pojedynczego detalu po krótką serię.",
            ...
            "realizations": {
                ...
                "h1": "Realizacje i kierunki prac, które dobrze pasują do naszej stolarni",
                "lead": "Najlepiej pracujemy tam, gdzie drewno wymaga dokładności, dopasowania i rozmowy o detalu. Poniżej pokazujemy typy zleceń, które warto wysłać do oceny.",
            },
            "quote": {
        ...
        "realization_cases": [
            {"title": "Schody drewniane z detalem metalowym", "category": "Stolarka budowlana", "photo": "stairs_project", "alt": "Schody drewniane z balustradą jako przykład realizacji stolarskiej", "meta": ["materiał: drewno", "zakres: wykonanie i dopasowanie", "typ: inwestor prywatny"], "body": "Zakres dla inwestycji, w których liczy się pomiar, stabilna konstrukcja, dopasowanie do wnętrza i staranne wykończenie widocznych detali."},
            {"title": "Drewniany detal do wnętrza", "category": "Custom / wnętrza", "photo": "precision_detail", "alt": "Precyzyjny detal drewniany do wnętrza premium", "meta": ["zakres: detal i wykończenie", "typ: projekt indywidualny", "obszar: Pomorskie"], "body": "Dobre zapytanie zaczyna się od zdjęcia, rysunku albo inspiracji. Po ocenie materiału i sposobu montażu można dobrać technologię wykonania."},
            {"title": "Drzwi, listwy i elementy stolarki", "category": "Drzwi / listwy / elementy", "photo": "doors_detail", "alt": "Drzwi drewniane jako przykład stolarki budowlanej na wymiar", "meta": ["zakres: stolarka budowlana", "typ: drzwi i wykończenie", "wycena: po zdjęciach i wymiarach"], "body": "To kierunek dla domów, lokali i inwestycji lokalnych, gdzie gotowy element nie pasuje wymiarem, materiałem albo oczekiwanym standardem."},
        ],
    },
}
...
CONTENT["en"] = {
    ...
    "pages": {
        "home": {
            ...
            "lead": "We combine production capability with made-to-measure joinery experience. We make wooden components, construction joinery and special projects: from one precise detail to a short production run.",
        ...
        "realizations": {
            ...
            "h1": "Project types that fit our joinery workshop well",
            "lead": "We are at our best where wood requires precision, fitting and a conversation about detail. Below are the kinds of inquiries worth sending for assessment.",
        },
        "quote": {
    ...
    "realization_cases": [
        {"title": "Wooden stairs with metal detail", "category": "Construction joinery", "photo": "stairs_project", "alt": "Wooden stairs with railing as an example of custom joinery", "meta": ["material: wood", "scope: production and fitting", "type: private investor"], "body": "A good fit for projects where measurement, a stable structure, interior alignment and careful finishing of visible details all matter."},
        {"title": "Wooden interior detail", "category": "Custom / interiors", "photo": "precision_detail", "alt": "Precise wooden detail for a premium interior", "meta": ["scope: detail and finish", "type: individual project", "region: Pomerania"], "body": "A useful inquiry starts with a photo, drawing or reference. After reviewing material and installation method, we can choose a sensible production approach."},
        {"title": "Doors, trims and joinery elements", "category": "Doors / trims / elements", "photo": "doors_detail", "alt": "Wooden doors as an example of made-to-measure construction joinery", "meta": ["scope: construction joinery", "type: doors and finishing", "quote: based on photos and dimensions"], "body": "This direction fits homes, venues and local projects where an off-the-shelf element does not match the dimensions, material or expected standard."},
    ],
}
...
_LOCALIZED_DETAILS = {
    "de": {
        ...
        "page_updates": {
            ...
            "realizations": {"title": "Schreinerprojekte und Projektarten | Kajax", "description": "Treppen, Türen, Leisten, Holzdetails, B2B-Elemente und Sonderanfertigungen. Sehen Sie, welche Arbeiten sich für eine Anfrage bei Kajax eignen.", "h1": "Projektarten, die gut zu unserer Tischlerei passen", "lead": "Wir arbeiten am stärksten dort, wo Holz Präzision, Anpassung und Abstimmung über Details braucht. Unten sehen Sie Anfragen, die sich zur Prüfung lohnen."},
    ...
    "sv": {
        ...
        "realization_cases": [
            {"title": "Trätrappa med metalldetalj", "category": "Byggsnickeri", "photo": "stairs_project", "alt": "Trätrappa med räcke som exempel på specialsnickeri", "meta": ["material: trä", "omfattning: tillverkning och anpassning", "typ: privat investerare"], "body": "Passar projekt där mätning, stabil konstruktion, anpassning till interiören och noggrann finish av synliga detaljer är viktigt."},
            {"title": "Trädetalj för interiör", "category": "Special / interiör", "photo": "precision_detail", "alt": "Precis trädetalj för en premiuminteriör", "meta": ["omfattning: detalj och finish", "typ: individuellt projekt", "region: Pommern"], "body": "En bra förfrågan börjar med foto, ritning eller referens. Efter granskning av material och montage kan vi välja rätt tillverkningssätt."},
            {"title": "Dörrar, lister och snickeridelar", "category": "Dörrar / lister / delar", "photo": "doors_detail", "alt": "Trädörrar som exempel på måttanpassat byggsnickeri", "meta": ["omfattning: byggsnickeri", "typ: dörrar och finish", "offert: efter foton och mått"], "body": "Passar hem, lokaler och lokala projekt där standarddelar inte stämmer med mått, material eller önskad nivå."},
        ],
        "page_updates": {
            ...
            "realizations": {"title": "Snickeriprojekt och projekttyper | Kajax", "description": "Trappor, dörrar, lister, trädetaljer, B2B-komponenter och måttanpassade projekt. Se vilka uppdrag som passar att skicka till Kajax för bedömning.", "h1": "Projekttyper som passar vår verkstad väl", "lead": "Vi är som starkast där trä kräver precision, anpassning och dialog om detaljer. Nedan visas förfrågningar som är värda att skicka för bedömning."},
    ...
    "da": {
        ...
        "realization_cases": [
            {"title": "Trætrappe med metaldetalje", "category": "Byggesnedkeri", "photo": "stairs_project", "alt": "Trætrappe med rækværk som eksempel på specialsnedkeri", "meta": ["materiale: træ", "omfang: produktion og tilpasning", "type: privat investor"], "body": "Passer til projekter, hvor opmåling, stabil konstruktion, tilpasning til interiøret og omhyggelig finish af synlige detaljer er vigtig."},
            {"title": "Trædetalje til interiør", "category": "Special / interiør", "photo": "precision_detail", "alt": "Præcis trædetalje til et premiuminteriør", "meta": ["omfang: detalje og finish", "type: individuelt projekt", "region: Pommern"], "body": "En god forespørgsel starter med foto, tegning eller reference. Efter vurdering af materiale og montage kan vi vælge en fornuftig produktionsmetode."},
            {"title": "Døre, lister og snedkerdele", "category": "Døre / lister / dele", "photo": "doors_detail", "alt": "Trædøre som eksempel på måltilpasset byggesnedkeri", "meta": ["omfang: byggesnedkeri", "type: døre og finish", "tilbud: efter fotos og mål"], "body": "Passer til boliger, lokaler og lokale projekter, hvor standarddele ikke passer til mål, materiale eller ønsket niveau."},
        ],
        "page_updates": {
            ...
            "realizations": {"title": "Snedkeriprojekter og projekttyper | Kajax", "description": "Trapper, døre, lister, trædetaljer, B2B-komponenter og måltilpassede projekter. Se hvilke opgaver der er værd at sende til Kajax for vurdering.", "h1": "Projekttyper der passer godt til vores værksted", "lead": "Vi er stærkest der, hvor træ kræver præcision, tilpasning og dialog om detaljer. Nedenfor er typer af forespørgsler, der er værd at sende til vurdering."},
    ...
    "no": {
        ...
        "realization_cases": [
            ...
            {"title": "Tredetalj til interiør", "category": "Spesial / interiør", "photo": "precision_detail", "alt": "Presis tredetalj til et premiuminteriør", "meta": ["omfang: detalj og finish", "type: individuelt prosjekt", "region: Pommern"], "body": "En god forespørsel starter med bilde, tegning eller referanse. Etter vurdering av materiale og montering kan vi velge en fornuftig produksjonsmåte."},
            {"title": "Dører, lister og snekkerdeler", "category": "Dører / lister / deler", "photo": "doors_detail", "alt": "Tredører som eksempel på måltilpasset byggsnekkerarbeid", "meta": ["omfang: byggsnekkerarbeid", "type: dører og finish", "tilbud: etter bilder og mål"], "body": "Passer boliger, lokaler og lokale prosjekter der standarddeler ikke stemmer med mål, materiale eller ønsket nivå."},
        ],
        "page_updates": {
            ...
            "realizations": {"title": "Snekkerprosjekter og prosjekttyper | Kajax", "description": "Trapper, dører, lister, tredetaljer, B2B-komponenter og måltilpassede prosjekter. Se hvilke oppdrag som passer å sende til Kajax for vurdering.", "h1": "Prosjekttyper som passer verkstedet vårt godt", "lead": "Vi er best der tre krever presisjon, tilpasning og dialog om detaljer. Nedenfor er forespørsler som er verdt å sende til vurdering."},
