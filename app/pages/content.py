    ...
    "pl": {
        ...
        "pages": {
            "home": {
                ...
                "description": "Stolarnia z Gościcina dla firm, architektów i inwestorów. Krótkie serie elementów drewnianych, schody, drzwi, listwy i wymagające realizacje na wymiar.",
                ...
                "h1": "Stolarnia dla firm, architektów i wymagających projektów z drewna",
                "lead": "Wykonujemy elementy drewniane dla firm, krótkie serie, stolarkę budowlaną i nietypowe detale. Pracujemy na zdjęciach, rysunkach i specyfikacjach, a przed wyceną jasno ustalamy zakres, materiał, termin i logistykę.",
                "primary_cta": "Wyślij projekt do wyceny",
                "secondary_cta": "Zobacz zakres prac",
            },
            "production": {
                "title": "Elementy drewniane i krótkie serie dla firm | Kajax",
                "description": "Krótkie serie, półprodukty i detale drewniane według wzoru, zdjęcia albo rysunku. Dla producentów, wykonawców, agencji reklamowych, firm eventowych i projektantów.",
                ...
                "h1": "Elementy drewniane i krótkie serie dla firm",
                "lead": "Pomagamy firmom zamawiać drewniane detale, półprodukty i krótkie serie bez budowania własnego zaplecza stolarskiego. Możemy zacząć od zdjęcia, rysunku, wzoru albo próbki, a po dopasowaniu procesu przejść do powtarzalnych zamówień.",
                "primary_cta": "Wyślij specyfikację do wyceny",
                "sections": [
                    {
                        "title": "Dla firm, które potrzebują przewidywalnej stolarni",
                        "body": "Dla producentów, agencji reklamowych i POS, firm eventowych, wykonawców wnętrz, manufaktur oraz projektantów, którzy potrzebują drewnianych elementów w małych lub powtarzalnych partiach.",
                        "items": ["prototypy i próbki", "krótkie serie", "elementy według wzoru", "stała współpraca po dopasowaniu procesu"],
                    },
                    {
                        "title": "Jakie elementy najlepiej pasują",
                        "body": "Najlepiej sprawdzają się elementy, które da się opisać wymiarem, materiałem, wykończeniem i powtarzalnością. Jeśli projekt ma sens logistyczny, możemy rozmawiać także o pakowaniu, wysyłce i stałych partiach.",
                    ...
                    {
                        "title": "Jak najprościej zacząć",
                        "body": "Wyślij zdjęcie, rysunek, próbkę albo krótki opis. Dopytamy o materiał, ilość, tolerancję, wykończenie i termin. Przy większej serii najbezpieczniej zacząć od próbki lub prototypu.",
                        "items": ["zdjęcie lub rysunek", "orientacyjna ilość", "materiał i wykończenie", "termin oraz sposób odbioru"],
                    },
                ],
                "faq": [
                    ("Czy realizujecie zamówienia B2B poza Pomorzem?", "Tak, jeśli projekt i logistyka mają sens. Dla elementów B2B możemy rozmawiać o współpracy w Polsce i Europie, ale wysyłka, pakowanie i zabezpieczenie elementów są ustalane indywidualnie."),
            ...
            "construction": {
                ...
                "h1": "Schody, drzwi i stolarka drewniana na wymiar w Pomorskiem",
                "lead": "Wykonujemy schody, drzwi, listwy, zabudowy i elementy wykończeniowe dla domów, lokali i inwestycji w Pomorskiem. To oferta dla projektów, w których gotowy element nie pasuje wymiarem, materiałem albo standardem wykonania.",
                "primary_cta": "Zapytaj o stolarkę budowlaną",
                "sections": [
                    {
                        "title": "Zakres prac",
                        "body": "Pomagamy przy elementach wykończeniowych i konstrukcyjnych z drewna, szczególnie tam, gdzie potrzebny jest pomiar, dopasowanie do wnętrza i porządne wykończenie widocznych detali.",
            ...
            "architects": {
                ...
                "h1": "Stolarnia do nietypowych detali i projektów dla architektów",
                "lead": "Pomagamy przełożyć koncepcję na wykonalny drewniany detal: do wnętrz, ekspozycji, lokali i projektów specjalnych. Pracujemy na rysunkach, inspiracjach, zdjęciach i ustaleniach technicznych z architektem albo wykonawcą.",
                "primary_cta": "Omów projekt",
                "sections": [
                    {
                        "title": "Kiedy warto napisać",
                        "body": "Gdy projekt wymaga rozmowy o detalu, materiale, sposobie montażu albo technologii wykonania, a gotowe rozwiązanie nie daje odpowiedniego efektu.",
            ...
            "realizations": {
                ...
                "lead": "Najlepiej pracujemy tam, gdzie drewno wymaga dokładności, dopasowania i technicznej rozmowy o detalu. Poniżej pokazujemy typy zleceń, które dobrze pasują do warsztatu i warto wysłać do oceny.",
            },
            "quote": {
                ...
                "lead": "Na start wystarczy krótki opis, zdjęcie, rysunek albo specyfikacja oraz telefon lub email. Jeśli temat pasuje do warsztatu, dopytamy o wymiary, materiał, ilość, termin i logistykę.",
            },
            "contact": {
        ...
        "process_steps": [
            ("Wysyłasz materiał", "Zdjęcie, rysunek, specyfikację albo krótki opis elementu, zastosowania i oczekiwanego efektu."),
            ("Dopytujemy technicznie", "Ustalamy materiał, ilość, wymiary, tolerancje, termin, wykończenie oraz odbiór, pakowanie lub logistykę."),
            ("Oceniamy dopasowanie", "Sprawdzamy, czy projekt pasuje do możliwości warsztatu, ma sens kosztowo i można go dobrze powtórzyć albo zamontować."),
            ("Próbka lub konkretna wycena", "Przy serii można zacząć od próbki. Przy prostszych pracach przechodzimy do wyceny po doprecyzowaniu zakresu."),
        ],
        "audience_cards": [
            {"title": "Elementy drewniane dla firm", "body": "Krótkie serie, półprodukty, elementy według wzoru i projekty B2B, w których liczy się powtarzalność oraz sprawny start od próbki.", "url": PATHS["production"], "cta": "Zobacz produkcję B2B"},
            {"title": "Stolarka budowlana", "body": "Schody, drzwi, listwy, zabudowy i drewniane elementy wykończeniowe dla inwestycji lokalnych w Pomorskiem.", "url": PATHS["construction"], "cta": "Zobacz zakres stolarki"},
            {"title": "Custom i trudniejsze realizacje", "body": "Nietypowe detale, realizacje według projektu i współpraca z architektami, projektantami oraz wykonawcami.", "url": PATHS["architects"], "cta": "Zobacz współpracę projektową"},
        ],
        "realization_cases": [
            ...
            {"title": "Drewniany detal do wnętrza lub ekspozycji", "category": "Custom / wnętrza", "photo": "precision_detail", "alt": "Precyzyjny detal drewniany do wnętrza premium", "meta": ["zakres: detal i wykończenie", "typ: projekt indywidualny", "obszar: Pomorskie"], "body": "Dobre zapytanie zaczyna się od zdjęcia, rysunku albo inspiracji. Po ocenie materiału, skali i sposobu montażu można dobrać sensowną technologię wykonania."},
...
CONTENT["en"] = {
    ...
    "pages": {
        "home": {
            "title": "Kajax Joinery | Wooden components for companies and custom joinery",
        ...
        "construction": {
            ...
            "h1": "Custom wooden stairs, doors and construction joinery in Pomerania",
    ...
    "audience_cards": [
        ...
        {"title": "Custom and demanding projects", "body": "Unusual details, project-based work and cooperation with architects, designers and contractors.", "url": PATHS["architects"], "cta": "See project cooperation"},
    ],
    "realization_cases": [
        ...
        {"title": "Wooden detail for an interior or display", "category": "Custom / interiors", "photo": "precision_detail", "alt": "Precise wooden detail for a premium interior", "meta": ["scope: detail and finish", "type: individual project", "region: Pomerania"], "body": "A useful inquiry starts with a photo, drawing or reference. After reviewing material, scale and installation method, we can choose a sensible production approach."},
...
SHORT_SERIES_GUIDE_PAGES = {
    "pl": {
        ...
        "lead": "Krótka seria ma sens wtedy, gdy firma potrzebuje powtarzalnych elementów, ale nie chce inwestować w własne zaplecze stolarskie. Najbezpieczniej zacząć od próbki, wzoru albo małej partii, a po dopasowaniu procesu przejść do regularnych zamówień.",
