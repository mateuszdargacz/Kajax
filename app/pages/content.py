    ...
    "pl": {
        ...
        "pages": {
            "home": {
                ...
                "h1": "Elementy z drewna dla firm, wnętrz i inwestycji",
                "lead": "W Kajax wykonujemy elementy, które muszą pasować do projektu: części do produktów i ekspozycji, próbki, krótkie serie, schody, drzwi, listwy oraz nietypowe detale. Pracujemy od zdjęcia, rysunku, wzoru albo specyfikacji. Jeśli temat pasuje do warsztatu, odpisujemy z konkretnymi pytaniami albo propozycją następnego kroku.",
                "primary_cta": "Wyślij projekt do oceny",
                "secondary_cta": "Zobacz ofertę",
            },
            "production": {
                "title": "Elementy drewniane dla firm, próbki i krótkie serie | Kajax",
                "description": "Elementy drewniane dla producentów, agencji i wykonawców. Profile, listwy, elementy POS, półprodukty, próbki i krótkie serie według wzoru.",
                ...
                "h1": "Elementy drewniane dla firm bez uruchamiania własnej stolarni",
                "lead": "Dla producentów, agencji reklamowych, wykonawców i marek, które potrzebują elementów z drewna do produktu, ekspozycji, opakowania, mebla albo dalszego montażu. Możemy zacząć od próbki, małej partii lub wzoru, który później wraca w kolejnych zamówieniach.",
                "primary_cta": "Wyślij element do oceny",
                "sections": [
                    {
                        "title": "Elementy do produktu, ekspozycji albo montażu",
                        "body": "Najlepiej sprawdzają się zlecenia, w których element ma określony kształt, wymiar i zastosowanie. Wtedy można dopracować wykonanie raz, a później wracać do tego samego wzoru.",
                    ...
                    {
                        "title": "Próbka przed powtarzalną partią",
                        ...
                        "items": ["pierwszy wzór do akceptacji", "ustalony standard wykonania", "powtarzalny efekt w kolejnych partiach", "pakowanie pod odbiór albo wysyłkę"],
                    },
                    {
                        "title": "Co wysłać, żeby szybko ocenić temat",
                        "body": "Najlepszy start to zdjęcie, rysunek, istniejący wzór albo krótka specyfikacja. Do tego liczba sztuk, materiał, termin i informacja, czy element ma być gotowy do użycia, czy do dalszej obróbki.",
                        "items": ["zdjęcie, rysunek, specyfikacja lub próbka", "pierwsza partia i możliwa skala docelowa", "materiał, kolor i standard wykończenia", "termin, pakowanie, odbiór albo wysyłka"],
                    },
                ],
                "faq": [
